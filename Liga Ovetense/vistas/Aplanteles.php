                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Auditoría /</span> Planteles</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Acciones sobre los Planteles</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                                  ...
                                  <table class='table table-bordered table-striped align-middle' id='tablaAuditoria'>
                                    ...
                                    <tbody>";
                                        $sql = "SELECT 
                                                ...
                                                FROM auditoria_planteles a
                                                LEFT JOIN planteles p ON a.idplantel = p.id
                                        ...
                                        if (mysqli_num_rows($res) > 0) {
                                          while ($row = mysqli_fetch_assoc($res)) {
                                            $plantel = ($row['nombre_club'] ?? 'Desconocido') . ' - ' . ($row['nombre_categoria'] ?? 'Sin categoría');
