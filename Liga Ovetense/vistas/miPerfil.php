                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Administración de Cuenta /</span> Mi Perfil</h4>
                        <div class='row justify-content-center'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'
                                  ><i class='bx bx-edit-alt me-1'></i>Datos de usuario</a
                                >
                              </li>
                            </ul>
                            <div class='card mb-6'>
                              <div class='card-body'>
                                <form action='../logica/editarPerfil.php' method='POST'>
                                  <div class='row'>
                                    <div class='col-md-8'>
                                      <div class='row'>
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='nombre'>Nombre</label>
                                          <input type='text' class='form-control' name='nombre' id='nombre' value=\"".$reg[1]."\" required />
                                        </div> 
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='ape'>Apellido</label>
                                          <input type='text' class='form-control' id='ape' name='ape' value=\"".$reg[2]."\" required />
                                        </div>
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='ci'>N° de Cédula</label>
                                          <input type='text' class='form-control' id='ci' name='ci' value=\"".$reg[3]."\" readonly />
                                        </div>
                                      </div>
                                      <div class='row'>
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='tel'>N° de Teléfono</label>
                                          <input type='text' class='form-control' id='tel' name='tel' value=\"".$reg[4]."\" required />
                                        </div>
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='dire'>Dirección</label>
                                          <input type='text' class='form-control' id='dire' name='dire' value=' ". htmlspecialchars($reg[5]) . "' required />
                                        </div>
                                        <div class='col-md-4 mb-3'>
                                          ...
                                          if (mysqli_num_rows($resP)>0){
                                            echo "<select class=\"form-select\" name=\"idF\" id=\"idF\" disabled>";
                                            $sqlP = "select * from liga order by id asc";
                                            $resP = mysqli_query($conexion, $sqlP);
                                      ...
                                      <div class='row'>
                                        <div class='col-md-4 mb-3'>
                                          ...
                                          <input type='email' class='form-control' id='email' name='email' value=\"".$reg[6]."\" required readonly/>
                                        </div>
                                        <div class='col-md-4 mb-3'>
                                        ...
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='nivel'>Nivel de Usuario</label>";
                                            if ($reg[8]=='1') {
                                              echo "<select class=\"form-select\" name='nivel' id='nivel' disabled>
                                    ...
                                    <div class='col-md-4 d-flex align-items-center justify-content-center'>
                                      <img src='../perfil.png' alt='Descripción de la imagen' style='width:200px; height: auto;' />
                                    </div>
                                  </div>
                                  ...
                                  <div class='row'>
                                    <div class='col-md-8'>
                                      ...
                                      <div class='row'>
                                        ...
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='dire'>Dirección</label>
                                          <input type='text' class='form-control' id='dire' name='dire' value=\"".$reg[5]."\" required />
                                        </div>
                                        <div class='col-md-4 mb-3'>
                                          <label class='form-label' for='idF'>Liga</label>";
                                          $sqlP = "select * from liga order by id asc";
