                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Ajustes del Sistema /</span> Liga</h4>
                        <div class='row justify-content-center'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'
                                  ><i class='bx bx-edit-alt me-1'></i>Datos de la Liga</a
                                >
                              </li>
                            </ul>
                            <div class='card mb-6'>
                              <div class='card-body'>
                                <form action='../logica/editarLiga.php' method='POST'>
                                  <div class='row'>
                                    <div class='col-md-8'>
                                      <div class='mb-3'>
                                        <label class='form-label' for='des'>Descripción</label>
                                        <input type='text' class='form-control' name='des' id='des' value=\"".$regt[1]."\" readonly />
                                      </div>
                                      <div class='mb-3'>
                                        <label class='form-label' for='tel'>N° de Teléfono</label>
                                        <input type='text' class='form-control' id='tel' name='tel' value=\"".$regt[2]."\" required />
                                      </div> 
                                      <div class='mb-3'>
                                        <label class='form-label' for='dire'>Dirección</label>
                                        <input type='text' class='form-control' id='dire' name='dire' value=\"".$regt[3]."\" required />
                                      </div>
                                      <div class='mb-3'>
                                        <label class='form-label' for='email'>Email</label>
                                        <input type='text' class='form-control' id='email' name='email' value=\"".$regt[4]."\" required />
                                      </div>
                                    </div>
                                    <div class='col-md-4 d-flex align-items-center justify-content-center'>
                                      <img src='../perfil.png' alt='Descripción de la imagen' style='width:300px; height: auto;' />
                                    </div>
                                  </div>
