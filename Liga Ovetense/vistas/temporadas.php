  ...
  <body>
                  ...
                  <div class='layout-page'>
                    ...
                    if ($r==1) {
                      ...
                      echo "<script>
                        swal.fire({
                          ...
                          text: 'La temporada ya se encuentra registrada',  
                        })
                        </script>";        
                    }else if ($r==3) {
                      echo "<script>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Campeonatos /</span> Registrar Temporada</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Listado de Temporadas</a>
                              </li>
                              <li class='nav-item'>
                                <button type='button' class='nav-link btn btn-link' disabled data-bs-toggle='modal' data-bs-target='#modalTemporada'>
                                  Registrar Nueva Temporada
                                </button>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              <h5 class='card-header'>Listado de Temporadas</h5>
                              <div class='card-body'>
                                ...
                                if (mysqli_num_rows($res1) > 0) {
                                  echo "<div class='table-responsive text-nowrap' style='overflow-x: auto; max-height: 800px;'>
                                    <table class='table table-hover'>
                                      ...
                                      <tbody  id='tablaTemporada' class='table-border-bottom-0 buscar'>";
                                        while ($reg1 = mysqli_fetch_array($res1)) {
                                          echo "<tr class='fila-editar' data-id='{$reg1['id']}' data-descripcion='{$reg1['descripcion']}' style='cursor: pointer; text-align: center;'>
                                            ...
                                            <td>
                                              <a class='btn btn-sm btn-danger' href='../logica/eliminarTemporada.php?usuario={$uActual}&id={$reg1['id']}'>
                      ...
                      <div class='modal fade' id='modalTemporada' tabindex='-1' aria-labelledby='modalTemporadaLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <form id='formTemporada' action='../logica/registrarTemporada.php' method='POST'>
                            <input type='hidden' name='usuario' value='$uActual'>
                            <div class='modal-content'>
                              <div class='modal-header'>
                                <h5 class='modal-title' id='modalTemporadaLabel'>Registrar Nueva Temporada</h5>
                      ...
                      <div class='modal fade' id='modalEditar' tabindex='-1' aria-labelledby='modalEditarLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <form action='../logica/editarTemporada.php' method='POST'>
                            <div class='modal-content'>
                              <div class='modal-header'>
                                <h5 class='modal-title' id='modalEditarLabel'>Editar Temporada</h5>
                                <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Cerrar'></button>
                              </div>
                              <div class='modal-body'>
                    ...
                    <ul class='menu-inner py-1'>
                      ...
                      <li class='menu-item active open'>
                        ...
                        <ul class='menu-sub'>
                          ...
                          <li class='menu-item active'>
                            <a href='../vistas/temporadas.php?usuario=$uActual' class='menu-link'>
                              <div data-i18n='Without menu'>Registrar Temporadas</div>
                            </a>
                          </li>
                        </ul>
                      </li>
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              ...
                              <li class='nav-item'>
                                <button type='button' class='nav-link btn btn-link' data-bs-toggle='modal' data-bs-target='#modalTemporada'>
                                  Registrar Nueva Temporada
                                </button>
                              </li>
                            </ul>
    ...
    <script>
      document.getElementById("formTemporada").addEventListener("submit", function(e) {
        ...
        fetch("../logica/registrarTemporada.php", {
          method: "POST",
          body: datos
        })
        .then(res => res.json())
        .then(data => {
          if (data.exito) {
            // Cerrar el modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalTemporada'));
            modal.hide();
            ...
            const nuevaFila = `
              <tr class="fila-editar" data-id="${data.id}" data-descripcion="${data.descripcion}" style="cursor: pointer; text-align: center;">
                ...
                <td>
                  <a class='btn btn-sm btn-danger' href='../logica/eliminarTemporada.php?usuario=${data.usuario}&id=${data.id}'>
                    <i class='bx bx-trash'></i>
                  </a>
                </td>
              </tr>
            ...
            document.getElementById("tablaTemporada").insertAdjacentHTML("afterbegin", nuevaFila);
        ...
        .catch(err => {
          alert("Ocurrió un error al registrar la Temporadadfsdfasd.", err);
          console.error(err);
        });
      });
    </script>
