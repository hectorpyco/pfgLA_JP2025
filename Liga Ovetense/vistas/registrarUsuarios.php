                          ...
                          <div class='row'>
                            <div class='col-md-12'>
                              ...
                              <div class='card mb-4'>
                                ...
                                <div class='card-body'>
                                   <form action='../logica/insertarUsuarios.php' method='POST'>
                                    <div class='row'>
                                    ...
                                    <div class='row'>
                                      ...
                                      <div class='col-md-4 mb-3'>
                                        <label class='form-label' for='if'>Liga</label>";
                                        $sqln = "select * from liga order by id asc";
                                        $resn = mysqli_query($conexion, $sqln);
                                        if (mysqli_num_rows($resn)>0){
                                          echo "<select class=\"form-select\" name=\"if\" id=\"if\">";
                                            while($regn=mysqli_fetch_array($resn)){
                                              echo "<option value=".$regn[0].">".$regn[1]."</option>";
                                            }
                                          echo "</select>";
                                        }else{
