...
<html lang="en">
  ...
  <body>
                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Administración /</span> Clubes</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Listado de Clubes</a>
                              </li>
                              <li class='nav-item'>
                                <button type='button' disabled class='nav-link btn btn-link' data-bs-toggle='modal' data-bs-target='#modalRegistrarClub'>
                                  Registrar Nuevo Club
                                </button>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              <h5 class='card-header'>Listado de Clubes</h5>
                              <div class='card-body'>
                                ...
                                $sql1 = "SELECT c.*, u.nombre AS presidente_nombre, u.apellido AS presidente_apellido, l.descripcion AS liga
                                 FROM clubes c
                                 LEFT JOIN usuarios u ON c.idpresidente = u.id
                                ...
                                if (mysqli_num_rows($res1) > 0) {
                                  echo "<div class='table-responsive text-nowrap' style='overflow-x: auto; max-height: 800px;'>
                                    <table class='table table-hover'>
                                      ...
                                      <tbody  id='tablaClubes' class='table-border-bottom-0 buscar'>";
                                        while ($reg1 = mysqli_fetch_array($res1)) {
                                          ...
                                          data-telefono='{$reg1['telefono']}'
                                          data-email='{$reg1['email']}'
                                          data-idpresidente='{$reg1['idpresidente']}'
                                          data-idliga='{$reg1['idliga']}'>
                                            <td>{$reg1['id']}</td>
                                            <td>{$reg1['descripcion']}</td>
                                            <td>{$reg1['direccion']}</td>
                                            <td>{$reg1['telefono']}</td>
                                            <td>{$reg1['email']}</td>
                                            <td>{$reg1['presidente_nombre']} {$reg1['presidente_apellido']}</td>
                                            <td>{$reg1['liga']}</td>
                                            <td>
                                              <a class='btn btn-sm btn-danger' href='../logica/eliminarClub.php?usuario={$uActual}&id={$reg1['id']}'>
                      ...
                      <div class='modal fade' id='modalRegistrarClub' tabindex='-1' aria-labelledby='modalRegistrarClubLabel' aria-hidden='true'>
                        <div class='modal-dialog modal-lg'>
                          <form id='formRegistrarClub' >
                            <div class='modal-content'>
                              <div class='modal-header'>
                                <h5 class='modal-title' id='modalRegistrarClubLabel'>Registrar Club</h5>
                              ...
                              <div class='modal-body'>
                                <div class='row'>
                                  <div class='col-md-6 mb-3'>
                                    ...
                                    <input type='text' name='club_descripcion' class='form-control' required>
                                  </div>
                                  <div class='col-md-6 mb-3'>
                                    <label class='form-label'>Dirección</label>
                                    <input type='text' name='club_direccion' class='form-control' required>
                                  </div>
                                </div>
                                <div class='row'>
                                  <div class='col-md-6 mb-3'>
                                    <label class='form-label'>Teléfono</label>
                                    <input type='text' name='club_telefono' class='form-control' required>
                                  </div>
                                  <div class='col-md-6 mb-3'>
                                ...
                                <div class='row'>
                                  <div class='col-md-6 mb-3'>
                                    ...
                                    <select name='club_presidente' class='form-control' required>
                                      <option value=''>Seleccione un presidente</option>";
                                        $sql = "SELECT id, nombre, apellido FROM usuarios WHERE idtipou = 3 AND estado = 'ACTIVO'";
                                        $res = mysqli_query($conexion, $sql);
                                  ...
                                  <div class='col-md-6 mb-3'>
                                    ...
                                    <select name='club_liga' class='form-control' required>
                    ...
                    <div class='modal fade' id='modalEditar' tabindex='-1' aria-labelledby='modalEditarLabel' aria-hidden='true'>
                      <div class='modal-dialog'>
                        <form action='../logica/editarClub.php' method='POST'>
                          <div class='modal-content'>
                            <div class='modal-header'>
                              <h5 class='modal-title' id='modalEditarLabel'>Editar Club</h5>
                              <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Cerrar'></button>
                            </div>
                            <div class='modal-body'>
                              <input type='hidden' name='club_id' id='editar_club_id'>
                              <div class='row'>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Nombre del Club</label>
                                  <input type='text' name='club_descripcion' id='editar_club_descripcion' class='form-control' required>
                                </div>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Dirección</label>
                                  <input type='text' name='club_direccion' id='editar_club_direccion' class='form-control' required>
                                </div>
                              </div>
                              <div class='row'>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Teléfono</label>
                                  <input type='text' name='club_telefono' id='editar_club_telefono' class='form-control' required>
                                </div>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Email</label>
                                  <input type='email' name='club_email' id='editar_club_email' class='form-control' required>
                                </div>
                              </div>
                              <div class='row'>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Presidente</label>
                                  <select name='club_presidente' id='editar_club_presidente' class='form-control' required>
                                    
                                  </select>
                                </div>
                                <div class='col-md-6 mb-3'>
                                  <label class='form-label'>Liga</label>
                                  <select name='club_liga' id='editar_club_liga' class='form-control' required>
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              ...
                              <li class='nav-item'>
                                <button type='button' class='nav-link btn btn-link' data-bs-toggle='modal' data-bs-target='#modalRegistrarClub'>
                                  Registrar Nuevo Club
                                </button>
                              </li>
                            </ul>
    ...
    <script>
      document.getElementById("formRegistrarClub").addEventListener("submit", function (e) {
        e.preventDefault();

        const form = e.target;
        const datos = new FormData(form);

        fetch("../logica/registrarClubes.php", {
          method: "POST",
          body: datos
        })
        .then(res => res.json())
        .then(data => {
          if (data.exito) {
            // Cerrar el modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('modalRegistrarClub'));
            modal.hide();
            ...
            const nuevaFila = `
              <tr class="fila-editar" style="text-align: center;"
                ...
                data-idpresidente="${data.idpresidente}"
              ...
              <td>${data.liga}</td>
              <td>
                <a class='btn btn-sm btn-danger' href='../logica/eliminarClub.php?id=${data.id}'>
                  <i class='bx bx-trash'></i>
                </a>
              </td>
            </tr>
            `;
            document.getElementById("tablaClubes").insertAdjacentHTML("afterbegin", nuevaFila);
        ...
        .catch(error => {
          ...
          alert("Ocurrió un error al registrar el club.");
        });
      });
    </script>
    ...
    <script>
      $(document).ready(function () {
        $(document).on('dblclick', '.fila-editar', function () {
          ...
          const presidente_id = $(this).data('idpresidente');
          const liga_id = $(this).data('idliga');

          $('#editar_club_id').val(id);
          $('#editar_club_descripcion').val(descripcion);
          $('#editar_club_direccion').val(direccion);
          $('#editar_club_telefono').val(telefono);
          $('#editar_club_email').val(email);

          $.ajax({
            url: '../logica/get_select_data.php',
            type: 'GET',
            dataType: 'json',
            success: function (data) {
              const selectPresidente = $('#editar_club_presidente');
              const selectLiga = $('#editar_club_liga');

              selectPresidente.empty();
              selectPresidente.append('<option value="">Seleccione un presidente</option>');
              data.presidentes.forEach(function (presidente) {
                const selected = presidente.id == presidente_id ? 'selected' : '';
                selectPresidente.append(`<option value="${presidente.id}" ${selected}>${presidente.nombre_completo}</option>`);
              });
            ...
            error: function () {
              alert('Error al cargar los datos de presidente y liga.');
            }
          });
        });
      });
