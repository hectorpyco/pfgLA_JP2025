  ...
  <body>
                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Configuración del Sistema /</span> Usuarios</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Acceso de los Usuarios</a>
                              </li>
                              <li class='nav-item'>
                                <a class='nav-link' href='../vistas/AAusuarios.php?usuario=$uActual'>Acciones sobre los Usuarios</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              ...
                              <div class='card-body'>
                                <div class='row mb-3'>
                                  ...
                                  <div class='col-md-4'>
                                    <label for='filtroExito' class='form-label'>Estado:</label>
                                    <select class='form-select' id='filtroExito'>
                                ...
                                <div class='table-responsive' style='overflow-x: auto; max-height: 800px;'>
                                  <table class='table table-bordered table-striped align-middle' id='tablaAuditoria'>
                                    ...
                                    <tbody>";
                                        $sql = "SELECT * FROM auditoria_accesos ORDER BY fecha_hora DESC";
                                        $res = mysqli_query($conexion, $sql);
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const filtroExito = document.getElementById("filtroExito");
        const filas = document.querySelectorAll("#tablaAuditoria tbody tr");

        function filtrarTabla() {
          const desde = fechaDesde.value;
          const hasta = fechaHasta.value;
          const estado = filtroExito.value.toUpperCase();

          filas.forEach(fila => {
            const fecha = fila.children[3].textContent.trim().substring(0, 10);
            const exito = fila.children[4].textContent.trim().toUpperCase();

            let mostrar = true;

            if (desde && fecha < desde) mostrar = false;
            if (hasta && fecha > hasta) mostrar = false;
            if (estado && exito !== estado) mostrar = false;
        ...
        filtroExito.addEventListener("change", filtrarTabla);
      });
    </script>
