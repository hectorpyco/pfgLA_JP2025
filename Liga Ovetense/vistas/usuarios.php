...
<html lang="en">
  ...
  <body>
    <?php
      ...
      $sqlt= "select * from liga where id='1'";
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Listado de Usuarios</a>
                              </li>
                              <li class='nav-item'>
                                <a class='nav-link' href='../vistas/registrarUsuarios.php?usuario=$uActual'>Registrar Nuevo Usuario</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              ...
                              <div class='card-body'>
                                ...
                                $sql1 = "SELECT u.id, u.nombre, u.apellido, u.ci, u.telefono, u.direccion, u.email,
                                          u.pass, u.idtipou, u.idliga, u.estado, l.descripcion AS liga_desc, t.descripcion AS tipo_desc
                                         FROM usuarios u
                                         INNER JOIN liga l ON u.idliga = l.id
                                         INNER JOIN tipou t ON u.idtipou = t.id
                                    ...
                                    <table class='table table-hover'>
                                      ...
                                      <tbody class='table-border-bottom-0 buscar'>";
                                        while ($reg1 = mysqli_fetch_array($res1)) {
                                          echo "<tr ondblclick=\"window.location.href='../vistas/editarUsuarios.php?usuario={$uActual}&id={$reg1['id']}'\" style='cursor: pointer; text-align: center;'>
                                            <td>{$reg1['id']}</td>
                                            <td>{$reg1['nombre']} {$reg1['apellido']}</td>
                                            <td>{$reg1['ci']}</td>
                                            <td>{$reg1['telefono']}</td>
                                            <td>{$reg1['direccion']}</td>
                                            <td>{$reg1['email']}</td>
                                            <td>{$reg1['liga_desc']}</td>
                                            <td>{$reg1['tipo_desc']}</td>
                                            <td>
                                              <a class='btn btn-sm btn-danger' href='../logica/eliminarUsuario.php?usuario={$uActual}&id={$reg1['id']}'>
