...
$('#exportar-pdf').on('click', function () {
  ...
  html2canvas(container, {
    ...
    <style>
      .card {
        height: 100%;  /* Hace que las tarjetas sean de tamaño uniforme */
      }
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link' href='../vistas/hFutbolistico.php?usuario=$uActual'>Listado de Historiales Futbolísticos</a>
                              </li>
                              <li class='nav-item'>
                            ...
                            <div class='card mb-4'>
                              <h5 class='card-header'>Listado de Jugadores Más Talentosos</h5>
                              <div class='card-body'>
                                <div class='row mb-3'>
                                  <div class='col-md-6'>
                                ...
                                ";
                                  ...
                                  $sql = "SELECT 
                                    ...
                                    -- Calculamos la puntuación de talento basada en los totales
                                    (SUM(h.goles) * 2) + 
                                  ...
                                  ORDER BY puntuacion_talento DESC"; // Ordenamos por la puntuación de talento
                                  $res = mysqli_query($conexion, $sql);
                                  if (mysqli_num_rows($res) > 0) {
                                    echo "<div class='row row-cols-1 row-cols-md-5 g-4'>"; // Cuadrícula de tarjetas
                ...
                <div class='layout-container'>
                  <aside id='layout-menu' class='layout-menu menu-vertical menu bg-menu-theme'>
                    ...
                    <ul class='menu-inner py-1'>
                      ...
                      <li class='menu-item active'>
                        <a href='../vistas/hFutbolistico.php?usuario=$uActual' class='menu-link'>
                          <div data-i18n='Without menu'>Historial Futbolístico</div>
                        </a>
                      </li>
                      <!--<li class='menu-item'>
                        <a href='../vistas/hFutbolistico.php?usuario=$uActual' class='menu-link'>
                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Historial Futbolístico de Jugadores</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);' class='menu-link'>Detalle Jugador</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              <h5 class='card-header'>Detalle Jugador</h5>
                              <div class='card-body'>
                                <div class='row mb-3'>
...
WHERE j.estado = 'ACTIVO'
ORDER BY h.fecha DESC"; // Ordenamos por la puntuación de talento
                                  $res = mysqli_query($conexion, $sql);
                                  if (mysqli_num_rows($res) > 0) {
                                    echo "<div class='row row-cols-1 row-cols-md-5 g-4'>"; // Cuadrícula de tarjetas
                                    while ($row = mysqli_fetch_assoc($res)) {
                                      ...
                                      echo "<div class='col mb-4 buscar fila-detalle' 
                                              ...
                                              <div class='card'>
                                                ...
                                                <div class='card-body'>
                                                  <h5 class='card-title'>{$row['nombre']} {$row['apellido']}</h5>
                                                  <p class='card-text'>
                                                    <strong>Temporada:</strong> {$row['goles']}<br>
                                                    <strong>Goles:</strong> {$row['goles']}<br>
                                                    <strong>Asistencias:</strong> {$row['asistencias']}<br>
                                                    <strong>Club Actual:</strong> {$row['nombre_club']}
                                                  </p>
  ...
  <div class='modal-header bg-primary text-white py-3'>
    <h5 class='modal-title text-white' id='detalleJugadorLabel'>Detalle del Jugador 3</h5>
