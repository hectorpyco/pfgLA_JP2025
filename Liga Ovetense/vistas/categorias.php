  ...
  <body>
                  ...
                  <div class='layout-page'>
                    ...
                    if ($r==1) {
                      ...
                      echo "<script>
                        swal.fire({
                          ...
                          text: 'La categoria ya se encuentra registrado',  
                        })
                        </script>";        
                    }else if ($r==3) {
                      echo "<script>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Administración /</span> Categorías</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Listado de Categorías</a>
                              </li>
                              <li class='nav-item'>
                                <button type='button' disabled class='nav-link btn btn-link' data-bs-toggle='modal' data-bs-target='#modalCategoria'>
                                ...
                                if (mysqli_num_rows($res1) > 0) {
                                  echo "<div class='table-responsive text-nowrap' style='overflow-x: auto; max-height: 800px;'>
                                    <table class='table table-hover'>
                                      ...
                                      <tbody  id='tablaCategorias' class='table-border-bottom-0 buscar'>";
                                        while ($reg1 = mysqli_fetch_array($res1)) {
                                          echo "<tr class='fila-editar' data-id='{$reg1['id']}' data-descripcion='{$reg1['descripcion']}' style='cursor: pointer; text-align: center;'>
                                            ...
                                            <td>
                                              <a class='btn btn-sm btn-danger' href='../logica/eliminarCategoria.php?usuario={$uActual}&id={$reg1['id']}'>
                      ...
                      <div class='modal fade' id='modalCategoria' tabindex='-1' aria-labelledby='modalCategoriaLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <form id='formCategoria' action='../logica/registrarCategoria.php' method='POST'>
                      ...
                      <div class='modal fade' id='modalEditar' tabindex='-1' aria-labelledby='modalEditarLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <form action='../logica/editarCategoria.php' method='POST'>
                            <div class='modal-content'>
                              <div class='modal-header'>
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              ...
                              <li class='nav-item'>
                                <button type='button' class='nav-link btn btn-link' data-bs-toggle='modal' data-bs-target='#modalCategoria'>
                                  Registrar Nueva Categoría
                                </button>
                              </li>
                            </ul>
    ...
    <script>
      document.getElementById("formCategoria").addEventListener("submit", function(e) {
        ...
        fetch("../logica/registrarCategoria.php", {
          method: "POST",
          body: datos
        })
        .then(res => res.json())
          ...
          if (data.exito) {
            ...
            const nuevaFila = `
              <tr class="fila-editar" data-id="${data.id}" data-descripcion="${data.descripcion}" style="cursor: pointer; text-align: center;">
                ...
                <td>
                  <a class='btn btn-sm btn-danger' href='../logica/eliminarCategoria.php?usuario=${data.usuario}&id=${data.id}'>
                    <i class='bx bx-trash'></i>
                  </a>
                </td>
              </tr>
            ...
            document.getElementById("tablaCategorias").insertAdjacentHTML("afterbegin", nuevaFila);
