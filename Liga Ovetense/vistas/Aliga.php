...
<html lang="en">
                  ...
                  <div class='layout-page'>
                    ...
                    <div class='content-wrapper'>
                      <div class='container-xxl flex-grow-1 container-p-y'>
                        <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Configuración del Sistema /</span> Liga</h4>
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Acciones sobre datos de la Liga</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                              ...
                              <div class='card-body'>
                                <div class='row mb-3'>
                                  ...
                                  <div class='col-md-4'>
                                    ...
                                    <select class='form-select' id='filtroAccion' disabled>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function filtrarTabla() {
      ...
      filas.forEach(fila => {
        const fecha = fila.children[3].textContent.trim().substring(0, 10); // Fecha y Hora
