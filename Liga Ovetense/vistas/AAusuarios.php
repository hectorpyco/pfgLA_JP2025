                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <ul class='nav nav-pills flex-column flex-md-row mb-3'>
                              <li class='nav-item'>
                                <a class='nav-link' href='../vistas/Ausuarios.php?usuario=$uActual'>Acceso de los Usuarios</a>
                              </li>
                              <li class='nav-item'>
                                <a class='nav-link active' href='javascript:void(0);'>Acciones sobre los Usuarios</a>
                              </li>
                            </ul>
                            <div class='card mb-4'>
                                ...
                                <div class='table-responsive' style='overflow-x: auto; max-height: 600px;'>
                                  <table class='table table-bordered table-striped align-middle' id='tablaAuditoria'>
                                    ...
                                    <tbody>";
                                        ...
                                        $usuario_afectado = isset($row['nombre']) ? $row['nombre'] . ' ' . $row['apellido'] : 'Desconocido';
                                        echo "
                                        <tr>
                                          <td>".($row['id'] ?? '-')."</td>
                                          <td>".htmlspecialchars($usuario_afectado)."</td>
